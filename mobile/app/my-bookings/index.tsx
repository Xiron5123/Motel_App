...
export default function MyBookingsScreen() {
    ...
    const { data: conversations, isLoading, refetch } = useQuery({
        ...
        queryFn: async () => {
            ...
            // Filter conversations that have at least one message with listing
            const withListings = response.data.filter((conv: any) =>
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.footer}>
                        <View style={styles.participant}>
                            ...
                            <Typography variant="caption" style={styles.participantName}>
        ...
        return (
            <SafeAreaView style={styles.container}>
                <View style={styles.header}>
                    <BackButton />
                    <Typography variant="h3">Phòng đã liên hệ</Typography>
                    <View style={{ width: 40 }} />
                </View>
                <View style={styles.emptyState}>
                    <Typography variant="body">Vui lòng đăng nhập để xem</Typography>
                </View>
            </SafeAreaView>
        );
    }
                    ...
                    !isLoading ? (
                        <View style={styles.emptyState}>
                            ...
                            <Typography variant="body" style={styles.emptyText}>
                                Khi bạn nhắn tin về một phòng trọ, nó sẽ hiển thị ở đây
                            </Typography>
                        </View>
                    ) : null
                }
