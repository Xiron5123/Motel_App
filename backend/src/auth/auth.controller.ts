...
export class AuthController {
  ...
  @ApiResponse({ status: 409, description: 'Email hoặc số điện thoại đã đăng ký' })
  ...
  @ApiResponse({ status: 200, description: 'Nếu email tồn tại, link đặt lại mật khẩu đã được gửi' })
